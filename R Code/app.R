...
# Load Salary Data
nba.salary_fullpred <- read_csv("https://raw.githubusercontent.com/summeryyang/NBA-Salary-Analysis/main/nba.salary_fullpred.csv")
...
download.file("https://raw.githubusercontent.com/summeryyang/NBA-Salary-Analysis/main/nbasalary.imp.xgb.rds", temp_file)
...
download.file("https://raw.githubusercontent.com/summeryyang/NBA-Salary-Analysis/main/fit_workflow.rds", temp_file2)
...
server <- function(input, output) {
  ...
  output$downloadTemplate <- downloadHandler(
    ...
    content = function(file) {
      download.file("https://github.com/summeryyang/NBA-Salary-Analysis/raw/main/Template.csv", file)
    }
  )
}
